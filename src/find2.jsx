...
import mobilKuningParticle from "./assets/find/find_mobilkuningparticle.png";
...
export default function Find2() {
  ...
  const handleObjClick = (obj) => {
    if (showModal) return;
    setTimerActive(false);
    if (obj === "mobilKuningParticle") {
      setModalType("win");
      setModalDesc("Pengendara ini Melanggar Marka Jalan !!!");
      setShowModal(true);
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <img
              src={mobilKuningParticle}
              alt="Mobil Kuning Particle"
              className="obj-mobil-kuning-particle"
              onClick={() => handleObjClick("mobilKuningParticle")}
              style={{ cursor: "pointer" }}
              tabIndex={0}
            />
          </div>
