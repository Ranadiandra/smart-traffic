// Reset status unlock setiap aplikasi dijalankan ulang
localStorage.setItem("dragndrop_unlocked", "false");
localStorage.setItem("find_unlocked", "false");
//KODE DIATAS HAPUS AJA KETIKA APLIKASI SUDAH SIAP, KARENA HANYA UNTUK TESTING
...
import Quis from "./QuisRandom.jsx";
import DragndropRandom from "./DragndropRandom.jsx";
import Find1 from "./find1.jsx"; // Import Find1 component
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/dragndrop" element={<DragndropRandom key={dragndropKey} />} />
